...
public class FFTLog extends PApplet {
	Minim minim;  
	AudioPlayer jingle;
	FFT fftLin;
	FFT fftLog;
...
public void setup() {
	  ...
	  jingle = minim.loadFile("06 - Billie Jean.mp3", 1024);
...
public void draw()
{
  ...
  // draw the linear averages
  {
    ...
    // rectangle should be.
    int w = new Integer( width/fftLin.avgSize() );
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { FFTLog.class.getName() };
    if(passedArgs != null)
    if (passedArgs != null) {
